...
if (typeof desirables === 'undefined') {
    ...
    /*KAO*/
    // 24 apps
    var desirables = ["skype", "firefox", "chrome", "silverlight", "7zip", "putty", "notepadplusplus", "sumatrapdf", "revo", "teamviewer12", "qbittorrent", "vlc", "vscode", "googlebackupandsync", "spotify", "dropbox", "libreoffice", "malwarebytes", "thunderbird", "java8", "steam", "windirstat", "python", "keepass2"]
}
