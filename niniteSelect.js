...
if (typeof desirables === 'undefined') {
    ...
    /*KAO*/
    var desirables = ["skype", "firefox", "chrome", "silverlight", "7zip", "putty", "notepadplusplus", "sumatrapdf", "revo", "teamviewer12", "qbittorrent", "vlc", "vscode", "googledrive", "spotify", "gimp", "dropbox", "libreoffice", "malwarebytes", "thunderbird", "java8", "eclipse"]
}
